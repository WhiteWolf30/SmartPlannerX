...
@EnableWebMvc
@EnableJpaRepositories(basePackages = "com.projectx.projectx.repository")
@PropertySources({
        @PropertySource("classpath:database.properties"),
        @PropertySource("classpath:hikariCP.properties"),
        @PropertySource("classpath:hibernate.properties")
})
@ComponentScan(basePackages = "com.projectx.projectx")
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManagerFactoryBean() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.projectx.projectx");
